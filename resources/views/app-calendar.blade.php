...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{config('app.url')}}assets/vendor/libs/fullcalendar/fullcalendar.css" />
    ...
    <link rel="stylesheet" href="{{config('app.url')}}assets/vendor/libs/quill/editor.css" />
    <link rel="stylesheet" href="{{config('app.url')}}assets/vendor/libs/@form-validation/form-validation.css" />

    <!-- Page CSS -->

    <link rel="stylesheet" href="{{config('app.url')}}assets/vendor/css/pages/app-calendar.css" />
  ...
  <body>
    ...
    <!-- Vendors JS -->
    <script src="{{config('app.url')}}assets/vendor/libs/fullcalendar/fullcalendar.js"></script>
    ...
    <script src="{{config('app.url')}}assets/vendor/libs/flatpickr/flatpickr.js"></script>
    ...
    <!-- Page JS -->
    <script src="{{config('app.url')}}assets/js/app-calendar-events.js"></script>
    <script src="{{config('app.url')}}assets/js/app-calendar.js"></script>
  </body>
</html>
